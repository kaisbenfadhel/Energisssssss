...
class EnricherAllServiceHelperTest extends FunSpec with Matchers with SparkSessionUtils  {

  it("should enrich 4 DataFrame meter ,sensor,raw_data and site with function enrich ") {
    ...
    EnricherAllServiceHelper(EnricherService("enricherall")).enrich(siteEnricher, meterEnricher, sensorCleanerDataFrame, rawDataDf).collect() should have length 18
  }
